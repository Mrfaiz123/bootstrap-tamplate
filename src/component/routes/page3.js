      ...
      <>
        ...
        <div className="col-lg-12 col-md-12 col-sm-12" style={{"position":"relative"}}>
              <div className="div text-center text-white">
                <h1 className="mt-4">Step 3: Experience</h1>
                <p className="mt-2">Let’s get you noticed!Work ecperience will increase your chances <br/> of landing that next job</p>
              </div>
            </div>
                ...
                <div className=" col-lg-10  d-flex flex-column justify-content-center" >
                  ...
                  <div className="d-flex  justify-content-between">
                    <div className="col-lg-5 ">
                          <p className="mt-3" style={{"font-weight":"bold","fontSize":"20px"}}>Job City<span className="text-danger">*</span></p>
                          <input placeholder="Manchester" className="text-secondary p-2 w-100"/>
                          <p className="mt-3" style={{"font-weight":"bold","fontSize":"20px"}}>Mobile<span className="text-danger">*</span></p>
                          <input placeholder="Fresh" className="text-secondary p-2 w-100"/>
                    ...
                    <div className="col-lg-5 ">
                          <p className="mt-3" style={{"font-weight":"bold","fontSize":"20px"}}>Expected Desgnation<span className="text-danger">*</span></p>
                          <input className="text-secondary p-2 w-100"/>
